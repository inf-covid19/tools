...
function ReproductionChart({ regionId }: { regionId: string }) {
  ...
  return (
    <ChartWrapper title="Reproduction Rate" subtitle="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas suscipit aliquam lectus eu auctor. Fusce pharetra leo et interdum bibendum.">
      {series ? (
